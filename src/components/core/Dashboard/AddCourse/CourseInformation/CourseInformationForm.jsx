  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6" >
      ...
      <div className="flex flex-col space-y-2">
        ...
        <select  {...register("courseCategory", { required: true })} defaultValue="Choose category" id="courseCategory" className="form-style w-full" >
          {/* <option value="A" > Choose a Category  </option> */}
